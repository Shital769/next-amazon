      ...
      <>
         ...
         <div className="grid md:grid-cols-4 md:gap-3 " >
            <div className="md:col-span-2">
               <Image src={product.image} alt={product.name} width={640} height={640} sizes="100vw" style={{
         ...
         <div>
            <div className="card bg-base-content text-white shadow-xl mt-3 md:mt-0 ">
               <div className="card-body bg-bas">
